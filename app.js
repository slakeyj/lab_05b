...
//     $('div:nth-child(2)').css({ 'background-color': 'orange' });
//     $('div:nth-child(3)').css({ 'background-color': 'yellow' });
//     $('div:nth-child(4)').css({ 'background-color': 'green' });
//     $('div:nth-child(5)').css({ 'background-color': 'blue' });
//     $('div:nth-child(6)').css({ 'background-color': 'indigo' });
//     $('div:nth-child(7)').css({ 'background-color': 'violet' });
//     $('div:nth-child(8)').css({ 'background-color': 'rgb(201, 195, 235)' });
//     $('div:nth-child(9)').css({ 'background-color': 'rgb(230, 185, 227)' });
//   }
